...
//como leer un ESModule recomendado por ahora
const jsonMovies = readJson("./movies.json");

//import del futuro
// import jsonMovies from './movies.json' with {type:'json'};

//una forma de como leer un json en ESModules
// import fs from "node:fs";
// const jsonMovies = JSON.parse(fs.readFileSync("./movies.json", "utf-8"));
